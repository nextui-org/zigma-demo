    ...
    <div className="mx-auto min-h-screen max-w-3xl">
      <header className="border-divider container mx-auto border-b sm:py-8">
        <nav className="flex items-center justify-between">
          <h1 className="font-heading text-2xl font-bold">ZigmaDemo</h1>
      ...
      <main className="container mx-auto pb-4">
        <section className="mb-8 pt-12">
          ...
          <p className="text-medium mb-4 mt-8">
            ZigmaDemo is a minimal, responsive, accessible and SEO-friendly React blog theme. This
            theme follows best practices and provides accessibility out of the box. Light and dark
            mode are supported by default. Moreover, additional color schemes can also be
            configured.
          </p>
          <p className="mb-4">
            Read the blog posts or check{" "}
            <a className="inline-block underline decoration-dashed underline-offset-4" href="#/">
              README
            </a>{" "}
            for more info.
          </p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="pt-2">
                ...
                <p className="text-foreground-muted text-small font-mono italic">{post.date}</p>
